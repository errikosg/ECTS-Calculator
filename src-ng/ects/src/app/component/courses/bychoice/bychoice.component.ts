...
@Component({
  selector: 'app-bychoice',
  templateUrl: './bychoice.component.html',
  styleUrls: ['./bychoice.component.css']
})
export class BychoiceComponent implements OnInit {
  ...
  getBychoice(){
    this.courseService.getBychoice().subscribe(data =>{
  ...
  sendTotal(){
    ...
    this.totalService.getBCGrades(this.total_grade);
  }
